...
Welcome to Capital! By downloading, installing, or using our mobile application ("App"), you agree to be bound by these Terms of Use ("Terms"). If you do not agree to these Terms, please do not use the App.

1. SERVICE DESCRIPTION
Capital provides real-time currency conversion tools and exchange rate information for personal and informational purposes. Our services include:
...
By accessing and using Capital, you accept and agree to be bound by the terms and provision of this agreement. These Terms apply to all users of the App.
...
To the maximum extent permitted by applicable law, Capital and its developers shall not be liable for:
...
If you have any questions about these Terms, please contact us at support@capital.am or via support.capital.am.

Thank you for choosing Capital!`,

      hy: `«CAPITAL» ԲՋՋԱՅԻՆ ՀԱՎԵԼՎԱԾԻ ՕԳՏԱԳՈՐԾՄԱՆ ՊԱՅՄԱՆՆԵՐ

Ուժի մեջ մտնելու ամսաթիվը՝ 2026 թվականի մայիսի 9

1. ԸՆԴՀԱՆՈՒՐ ԴՐՈՒՅԹՆԵՐ
1.1. Սույն Օգտագործման պայմանները (այսուհետ՝ «Պայմաններ») կարգավորում են «Capital» անվանումը կրող բջջային հավելվածի (այսուհետ՝ «Հավելված») ներբեռնման, տեղադրման և օգտագործման իրավական հարաբերությունները Հավելվածի օգտագործողի (այսուհետ՝ «Օգտագործող») և Հավելվածի իրավատիրոջ/մշակողի (այսուհետ՝ «Մշակող») միջև:
1.2. Հավելվածը ներբեռնելով, տեղադրելով կամ որևէ կերպ օգտագործելով՝ Օգտագործողը համարվում է ամբողջությամբ ծանոթացած և անվերապահ ընդունած սույն Պայմանները: Եթե Օգտագործողը չի համաձայնում Պայմանների որևէ դրույթի հետ, նա պարտավոր է չօգտագործել Հավելվածը:

2. ՍԱՀՄԱՆՈՒՄՆԵՐ
2.1. «Ծառայություն»՝ Հավելվածի միջոցով մատուցվող գործառույթների ամբողջությունը, ներառյալ՝ բայց չսահմանափակվելով, արժույթների փոխարժեքների ցուցադրումը, փոխարկման հաշվարկները, գրաֆիկները, պահպանված զույգերը, փոխարժեքի ծանուցումները, հաշվիչը, զբոսաշրջային հաշվարկային մոդուլը, ինչպես նաև Հայաստանի Հանրապետության իրավական դաշտին վերաբերող տեղեկատվական/հաշվարկային մոդուլները:
2.2. «Տեղեկատվություն»՝ Հավելվածում ցուցադրվող կամ հաշվարկված ցանկացած տվյալ, ներառյալ փոխարժեքները և արդյունքային թվեր:

3. ԾԱՌԱՅՈՒԹՅԱՆ ՆԿԱՐԱԳՐՈՒԹՅՈՒՆ
3.1. Հավելվածը նախատեսված է առաջին հերթին անձնական, տեղեկատվական և հաշվարկային օգնության նպատակներով, այդ թվում՝
• արտարժույթների նկատմամբ փոխարժեքների և դրանց դինամիկայի ցուցադրում,
• մեկ կամ մի քանի արժույթների նկատմամբ փոխարկման արդյունքների ստացում,
• պահպանված արժութային զույգերի վարում (տեղայնորեն և/կամ, համապատասխան գործառույթների առկայության դեպքում, հաշվի հետ կապված սինքրոնացում),
• թիրախային դրույքի հասնելու դեպքում ծանուցումների ուղարկում (տեխնիկապես հնարավոր սահմանափակումներով),
• ներկառուցված հաշվիչ, այդ թվում վարկի ամսական մարման մոդելավորում,
• Հայաստանի Հանրապետությանը վերաբերող ֆինանսական/հարկային տեղեկատվական գործիքներ (եթե նման մոդուլները ներառված են Հավելվածում):
3.2. Պայմանների ոչ մի դրույթ չի կարող մեկնաբանվել որպես ֆինանսական, հարկային, իրավական խորհրդատվության, բրոկերային, ապահովագրական կամ ներդրումային ծառայության մատուցման պարտավորություն:

4. ՊԱՅՄԱՆՆԵՐԻ ԸՆԴՈՒՆՈՒՄ
Օգտագործելով Հավելվածը՝ Օգտագործողը հաստատում է, որ իր գործողությունները չեն խախտում իրեն կիրառելի օրենսդրությունը և որ նա պատասխանատու է Հավելվածից ստացված Տեղեկատվության օգտագործման համար:

5. ՕԳՏԱԳՈՐԾՄԱՆ ԼԻՑԵՆԶԻԱ
5.1. Սույն Պայմանների պահպանման պայմանով Մշակողը Օգտագործողին տրամադրում է սահմանափակ, ոչ բացառիկ, անձնական, ոչ փոխանցելի, ենթալիցենզիա չտրամադրելու ենթակա իրավունք՝ Հավելվածը տեղադրելու և օգտագործելու համար:
5.2. Արգելվում է Հավելվածը վարձակալել, վաճառել, ենթալիցենզավորել, ապամոնտաժել, հետադարձ ինժեներություն կատարել, շրջանցել տեխնիկական պաշտպանությունը, ինչպես նաև ստեղծել ածանցյալ աշխատանքներ առանց Մշակողի նախնական գրավոր համաձայնության:

6. ԱՐԳԵԼՎԱԾ ԳՈՐԾՈՂՈՒԹՅՈՒՆՆԵՐ
Օգտագործողը պարտավորվում է չկատարել հետևյալ գործողությունները.
• Հավելվածի կամ կապակցված ենթակառուցվածքի նկատմամբ ցանկացած ձևի չարտոնված մուտք, հարձակում, վիրուսների տարածում կամ ծանրաբեռնվածության արհեստական ստեղծում,
• ավտոմատացված միջոցներով (scraping, bot և այլն) տվյալների հավաքում առանց թույլտվության,
• Հավելվածի միջոցով կեղծ, մոլորեցնող կամ ապօրինի բովանդակության տարածում:

7. ՏԵՂԵԿԱՏՎՈՒԹՅԱՆ, ՓՈՂԱՐԺԵՔՆԵՐԻ ԵՎ ՀԱՇՎԱՐԿՆԵՐԻ ՄԱՍԻՆ ՀՐԱԺԱՐՈՒՄ
7.1. Փոխարժեքները, գրաֆիկները և հաշվարկային արդյունքները տրամադրվում են «ինչպես կա» («as is») սկզբունքով՝ բացառապես տեղեկատվական նպատակով:
7.2. Մշակողը չի երաշխավորում Տեղեկատվության անխափան թարմացում, ամբողջականություն, անխափան հասանելիություն, սխալների բացակայություն կամ համընկնում բանկային, արժեթղթային կամ այլ պաշտոնական դրույքների հետ:
7.3. Օգտագործողը պարտավոր է ցանկացած վճարային, հարկային կամ այլ պարտավորությունների համար հիմք ընդունել միայն իր անկախ ստուգված տվյալները:

8. ՀՀ-ԻՆ ՎԵՐԱԲԵՐՈՂ ԳՈՐԾԻՔՆԵՐԻ ՄԱՍԻՆ ՀՐԱԺԱՐՈՒՄ
Եթե Հավելվածում առկա են Հայաստանի Հանրապետության օրենսդրությանը, հարկային կամ այլ պետական կարգավորումներին վերաբերող մոդուլներ, դրանք նախատեսված են միայն ընդհանուր ծանոթության և նախնական հաշվարկների համար: Դրանք չեն փոխարինում պետական մարմինների պաշտոնական ակտերը, հաշվետվությունները կամ մասնագետների խորհրդատվությունը, և չեն կարող հիմք հանդիսանալ իրավական պահանջների կամ պարտավորությունների ձևակերպման համար:

9. ԵՐԱՇԽԻՔՆԵՐԻ ԲԱՑԱՌՈՒՄ
Օրենքով թույլատրելի առավելագույն չափով բացառվում են ցանկացած հստակ կամ ենթադրյալ երաշխիքներ, այդ թվում՝ վաճառքի ենթադրյալ համապատասխանության կամ որոշակի նպատակի համար հարմար լինելու վերաբերյալ:

10. ՊԱՏԱՍԽԱՆԱՏՎՈՒԹՅԱՆ ՍԱՀՄԱՆԱՓԱԿՈՒՄ
10.1. Օրենքով թույլատրելի առավելագույն չափով Մշակողը, նրա կազմակերպությունը, աշխատակիցները և գործընկերները պատասխանատվություն չեն կրում ցանկացած անուղղակի, պատահական, հատուկ, պատժիչ կամ հետևանքային վնասների, շահույթի կամ տվյալների կորստի, ինչպես նաև Հավելվածի օգտագործման կամ չօգտագործման հետևանքով առաջացած որևէ այլ վնասի համար:
10.2. Եթե պատասխանատվության բացառումը որոշակի դեպքում չի կիրառվում, Մշակողի ընդհանուր պատասխանատվությունը սահմանափակվում է այն գումարով, որը Օգտագործողը փաստացի վճարել է Մշակողին Հավելվածի համար վերջին տասներկու (12) ամիսների ընթացքում, կամ, եթե վճար չի կատարվել, զրոյական գումարով:

11. ԳԱՂՏՆԻՈՒԹՅԱՆ ՔԱՂԱԿԱՆՈՒԹՅՈՒՆ
Անձնական տվյալների մշակման կարգը, եթե նման կարգ կիրառվում է, կարգավորվում է առանձին գաղտնիության քաղաքականությամբ (եթե այն հրապարակված է) և կիրառելի օրենքով: Օգտագործողը պարտավոր է ծանոթանալ «Գաղտնիության քաղաքականություն» փաստաթղթին:

12. ՊԱՅՄԱՆՆԵՐԻ ՓՈՓՈԽՈՒԹՅՈՒՆՆԵՐ
Մշակողը իրավունք ունի միակողմանի կարգով փոփոխել սույն Պայմանները: Էական փոփոխությունների մասին, հնարավորության սահմաններում, կարող է տեղեկացվել Հավելվածի միջոցով: Պայմանների թարմացված տարբերակի ուժի մեջ մտնելուց հետո Հավելվածի շարունակական օգտագործումը համարվում է փոփոխված Պայմանների ընդունում:

13. ԾԱՌԱՅՈՒԹՅԱՆ ԴԱԴԱՐՈՒՄ
Մշակողը իրավունք ունի ցանկացած ժամանակ, առանց նախնական ծանուցման, ամբողջությամբ կամ մասնակիորեն դադարեցնել կամ սահմանափակել Հավելվածի մատուցումը, եթե դա անհրաժեշտ է օրենքի, անվտանգության կամ տեխնիկական պատճառներով:

14. ԿԻՐԱՌԵԼԻ ԻՐԱՎՈՒՆՔ ԵՎ ՎԵՃԵՐԻ ԼՈՒԾՈՒՄ
14.1. Սույն Պայմաններին վերաբերող հարաբերությունները ենթակա են կարգավորման այն պետության օրենսդրությամբ, որի օրենքները կիրառելի են Մշակողի նկատմամբ, եթե պարտադիր նորմերով այլ բան նախատեսված չէ:
14.2. Վեճերը, հնարավորության դեպքում, ենթակա են բանակցությունների, ապա՝ կիրառելի օրենքով նախատեսված դատարանական կարգով:

15. ԿԱՊԻ ՏՎՅԱԼՆԵՐ
Սույն Պայմաններին, Ծառայությանը կամ Հավելվածին վերաբերող հարցերով կարելի է դիմել support@capital.am էլեկտրոնային փոստով կամ support.capital.am կայքէջի միջոցով:

Շնորհակալություն «Capital»-ը ընտրելու համար:`,

      ru: `Условия использования Capital

Дата вступления в силу: 10 января 2025 года

Добро пожаловать в Capital! Загружая, устанавливая или используя наше мобильное приложение ("Приложение"), вы соглашаетесь соблюдать настоящие Условия использования ("Условия"). Если вы не согласны с настоящими Условиями, пожалуйста, не используйте Приложение.

1. ОПИСАНИЕ СЕРВИСА
Capital предоставляет инструменты конвертации валюты и информацию о курсах обмена в реальном времени для личного и информационного использования. Наши услуги включают:
...
2. ПРИНЯТИЕ УСЛОВИЙ
Получая доступ к Capital и используя его, вы принимаете и соглашаетесь соблюдать условия и положения настоящего соглашения. Настоящие Условия применяются ко всем пользователям Приложения.
...
В максимально допустимой степени, разрешенной применимым законодательством, Capital и его разработчики не несут ответственности за:
...
Если у вас есть вопросы по настоящим Условиям, пожалуйста, свяжитесь с нами по адресу support@capital.am или через support.capital.am.
...
Si tienes preguntas sobre estos Términos, por favor contáctanos en support@capital.am o a través de support.capital.am.
...
11. 联系信息
如果您对这些条款有任何疑问，请通过 support@capital.am 或 support.capital.am 与我们联系。
...
11. संपर्क जानकारी
यदि आपके पास इन शर्तों के बारे में कोई प्रश्न हैं, तो कृपया support@capital.am या support.capital.am के माध्यम से हमसे संपर्क करें।
            ...
            <View style={styles.settingItem}>
              ...
              <ThemedText style={[styles.settingValue, { flex: 1, textAlign: 'right' }]} numberOfLines={2}>
                {exchangeRateData?.time_last_update_utc
                  ? formatDateTimeDDMMYY(exchangeRateData.time_last_update_utc)
                  : '…'}
              </ThemedText>
            </View>
            <View style={styles.settingItem}>
              ...
              <ThemedText style={[styles.settingValue, { flex: 1, textAlign: 'right' }]} numberOfLines={2}>
                {exchangeRateData?.time_next_update_utc
                  ? formatDateTimeDDMMYY(exchangeRateData.time_next_update_utc)
                  : '…'}
              </ThemedText>
            </View>
          </View>
